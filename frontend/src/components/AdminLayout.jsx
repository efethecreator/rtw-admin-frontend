    ...
    <div className="flex bg-blue min-h-screen">
      <div className="w-65 p-8 shadow-xl flex flex-col items-start bg-gradient-to-t from-[#207c6c] to-white">
        <img
          src={logo}
          alt="iView Logo"
          className="w-40 h-auto mb-6 ml-16 mt-55"
        />
        <ul className="space-y-6">
          <li>
            <Link
              to="/admin-dashboard/questions"
              className="ml-2 block text-lg font-medium text-black py-2 px-4 rounded-lg hover:bg-[#B3D2CD] hover:text-gray-700 hover:shadow-lg transition-all duration-300 relative"
            >
